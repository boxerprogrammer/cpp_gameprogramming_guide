...
private:
	...
	void DyingDraw();
public:
	Boss(GameScene& gameScene, int handle, std::shared_ptr<Player> player, std::shared_ptr<BulletFactory> bulletFactory, std::shared_ptr<EffectFactory> effectFactory, Vector2 pos);
